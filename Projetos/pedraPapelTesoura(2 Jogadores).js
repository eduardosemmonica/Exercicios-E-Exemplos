...
do {
    ...
    escolha2 = prompt("Escolha uma Jogador 2 opção: ");
    ...
    if (escolha === escolha2) {
        ...
        console.log("A vitória é do Jogador 1! 🪨 Pedra ganha de ✂️ Tesoura");

    } else if (escolha === "1" && escolha2 === "2") {
        console.log("A vitória é do Jogador 2! 📄 Papel ganha de 🪨 Pedra");

    } else if (escolha === "2" && escolha2 === "1") {
        console.log("A vitória é do Jogador 1! 📄 Papel ganha de 🪨 Pedra");

    } else if (escolha === "2" && escolha2 === "3") {
        console.log("A vitória é do Jogador 2! ✂️ Tesoura ganha de 📄 Papel");

    } else if (escolha === "3" && escolha2 === "1") {
        console.log("A vitória é do Jogador 2! 🪨 Pedra ganha de ✂️ Tesoura");

    } else if (escolha === "3" && escolha2 === "2") {
        console.log("A vitória é do Jogador 1! ✂️ Tesoura ganha de 📄 Papel");
    }
